...
export default function ListCliente() {
  ...
  async function remover() {
    await axios
      ...
      .then((response) => {
        console.log("ptoduto removido com sucesso.");
            ...
            <Table color="orange" sortable celled>
              <Table.Header>
                <Table.Row>
                  ...
                  <Table.HeaderCell>Tempo de estrega Mínima</Table.HeaderCell>
                  <Table.HeaderCell>Tempo de estrega Máxima</Table.HeaderCell>
